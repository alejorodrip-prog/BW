...
1) HEADER / NAV (sticky, transitions from transparent-on-hero to solid navy-900 on
   ...
   - Nav, in this order:
     ...
     6. Company ▾ (dropdown: About Us, Locations, Careers). Locations moves here
        ...
        it doesn't lose visibility by moving in the nav.
...
9) PARTS, SERVICE & FINANCING (3-column feature block; DRAFT copy)
   ...
   BWEG_Design_Prompt_Services_v1.md), which didn't exist in the earlier draft, so
   this button had nowhere to go. "Check My Rate" can stay a placeholder/mock
   action until financing is scoped in a later round.
